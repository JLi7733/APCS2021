document.addEventListener('DOMContentLoaded', () => {
  ...
  //Variables we define for the basics of the game
  const width = 10
  let currentIndex = 0 //so first div in our grid
  let appleIndex = 0 //so first div in our grid
  let currentSnake = [2,1,0] //2 is head, 0 is tail, and 1 is everything in between
  let direction = 1
  let score = 0
  let speed = 0.9
  let intervalTime = 0
  ...
  function startGame() {
    //This is deleting the last game
    ...
    randomApple()
    direction = 1
    //Now this is starting the new game
